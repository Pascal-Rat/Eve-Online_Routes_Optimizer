...
def solve_exhaustively(
    ...
    best_reward_units: int | None = None
    ...
    while states_to_explore:
        ...
        if picked_contracts_mask == delivered_contracts_mask and can_reach_required_finish(
            ...
            best_reward_units = max(
                best_reward_units if best_reward_units is not None else 0,
        ...
        for contract_index in range(contract_count):
            ...
            jump_count = problem.jump_matrix.get((current_system_id, pickup_system_id))
        ...
        for contract_index in range(contract_count):
            ...
            jump_count = problem.jump_matrix.get((current_system_id, delivery_system_id))
            if jump_count is None:
                continue
