...
from eve_courier_optimizer.verification.route_replay import SimulationResult, simulate_and_verify
...
def check_selection(
    ...
    *,
    ...
    if status in (cp_model.OPTIMAL, cp_model.FEASIBLE):
        ...
        simulation = simulate_and_verify(problem, graph, visits, solved_contract_ids)
