...
from eve_courier_optimizer.domain import OptimalityCertificate, ProofStatus, SolveResult
from eve_courier_optimizer.optimization.search.contract_selection import SelectionProof
...
def canonical_problem_sha256(problem: RouteProblem) -> str:
    ...
    payload: dict[str, Any] = {
        ...
        "jump_matrix": [
            ...
            for (source, destination), jumps in sorted(problem.jump_matrix.items())
        ],
    }
...
def certify(
    ...
    *,
    ...
    certificate = OptimalityCertificate(
        ...
        problem_sha256=canonical_problem_sha256(problem),
