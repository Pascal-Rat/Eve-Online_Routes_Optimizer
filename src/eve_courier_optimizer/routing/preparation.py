...
from .policy import reachable_threat_regions
from .universe import UniverseGraph
...
class PreparedProblem:
    ...
    def restrict_contracts(self, selected_contract_ids: tuple[int, ...]) -> PreparedProblem:
        ...
        known_contract_ids = {contract.contract_id for contract in self.problem.contracts}
        ...
        return PreparedProblem(
            problem=replace(self.problem, contracts=selected_contracts),
            jump_matrix=self.jump_matrix,
