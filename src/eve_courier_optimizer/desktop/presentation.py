...
from eve_courier_optimizer.application.execution import ExecutionState, execution_state_to_dict
...
def execution_payload(
    execution: ExecutionState | None, graph: UniverseGraph, at: datetime
) -> JsonObject | None:
    if execution is None:
        return None
    payload = execution_state_to_dict(execution)
...
def scope_payload(prepared: PreparedProblem) -> JsonObject:
