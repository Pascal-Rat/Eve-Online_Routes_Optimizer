...
from eve_courier_optimizer.desktop.jobs import BackgroundJobs
...
from tests.desktop.test_server import CourierTransport, planning_payload, post_json
...
@pytest.fixture
def job_app(tiny_graph: UniverseGraph, tmp_path: Path) -> PlanningSession:
...
@pytest.fixture
def jobs(job_app: PlanningSession) -> Iterator[BackgroundJobs]:
...
def test_optional_activity_timeout_keeps_successful_contract_scan(
    ...
    app = PlanningSession(tiny_graph, client, tmp_path)
