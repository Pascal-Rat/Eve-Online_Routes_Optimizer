...
from tests.web.test_server import CourierTransport, planning_payload, post_json
...
@pytest.fixture
def job_app(tiny_graph: UniverseGraph, tmp_path: Path) -> PlanningWorkspace:
...
def test_optional_activity_timeout_keeps_successful_contract_scan(
    ...
    app = PlanningWorkspace(tiny_graph, client, tmp_path)
